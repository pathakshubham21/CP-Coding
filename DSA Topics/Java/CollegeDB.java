...
//     static int Login_fail_count = 1;
//     static nextStudent = 2;
//     }
...
//     public void DisplayStudentData(StudentInfo student) {
//             System.out.println("Student Name: " + student.Name +"\n"+ 
//                                " Registration Number: " + student.RegNo +"\n"+  
//                                " Branch: " + student.Branch + "\n"+ 
//                                " Passout Year: " + student.PassoutYear+ "\n");
...
//                         student.PassoutYear = NewPassoutYear;
//                         System.out.println("Updated");
//                         break;
...
//     public boolean Add_New_Student(StudentInfo New_Student)
//     {
...
//         String New_Student_Name = sc.next();

//         System.out.println("Enter New Student Registration Number: ");
//         int New_Student_RegNo = sc.nextInt();

//         System.out.println("Enter New Student Branch: ");
//         String New_Student_Branch = sc.next();

//         System.out.println("Enter New Student Passout Year: ");
//         int New_Student_PassoutYear = sc.nextInt();

//         }
//         else{
//             System.out.println("Login to Add the Data");
//             InputLogin();
//             Add_New_Student();
//         }
...
//         StudentInfo[] Students = new StudentInfo[5]; // Creates an array that can hold 5 StudentInfo objects
        

//         StudentInfo Students[0] = new StudentInfo("Shubham", 1170, "CSE", 2021);
//         StudentInfo Students[1] = new StudentInfo("Robin", 1234, "ECE", 2022);
//         Scanner sc = new Scanner(System.in);
...
//                             Students[i].DisplayStudentData(Students[i]);
//                         break;
//                     case 2:
//                         // for(int i=0;i<Students.length;i++)
